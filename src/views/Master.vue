    ...
    <div class="page-wrapper">
          ...
          <ul class="nav navbar-toolbar">
            <li class="dropdown dropdown-inbox">
              ...
              <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                ...
                <li
                  class="list-group list-group-divider scroller"
                  data-height="240px"
                  data-color="#71808f"
                >
                  <div>
                    <a class="list-group-item">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <div class="font-strong"></div>Jeanne Gonzalez
                    ...
                    <a class="list-group-item">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <div class="font-strong"></div>Becky Brooks
                    ...
                    <a class="list-group-item">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <div class="font-strong"></div>Frank Cruz
                          <small class="text-muted float-right">18 mins</small>
                          <div class="font-13">Lorem Ipsum is simply.</div>
                        </div>
                      </div>
                    ...
                    <a class="list-group-item">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <div class="font-strong"></div>Rose Pearson
                ...
                >
                  <div>
                    ...
                    <a class="list-group-item">
                      <div class="media">
                        <div class="media-img">
                          <span class="badge badge-default badge-big">
          ...
          <ul class="side-menu metismenu">
            ...
            <li>
              <a href="javascript:;">
                ...
                <span class="nav-label">Basic UI</span>
      ...
      <div class="content-wrapper">
        ...
        <footer class="page-footer">
          <div class="font-13">
            2018 ©
            <b>AdminCAST</b> - All rights reserved.
          </div>
          <a
            class="px-4"
...
<script>
import ContentWrap from "@/views/ContentWrap.vue";
export default {
  components: {
    ContentWrap
  }
